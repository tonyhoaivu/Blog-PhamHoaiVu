      ...
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="bg-gradient-to-r from-blue-700 to-blue-500 rounded-[40px] shadow-2xl shadow-blue-500/20 overflow-hidden relative">
          <div className="relative z-10 p-10 md:p-16 grid grid-cols-1 md:grid-cols-3 gap-12 text-white">
            ...
            <div>
              <h3 className="font-black text-white/50 mb-8 uppercase text-[11px] tracking-[0.3em]">CHUYÊN MỤC</h3>
              <ul className="grid grid-cols-2 gap-x-4 gap-y-3">
                {['Win 7', 'Win 8', 'Win 10', 'Win 11', 'Driver PC', 'Máy In', 'BOOT USB', 'Thủ thuật', 'PC Game', 'Mobile Game'].map(m => (
                  <li key={m}><button onClick={() => navigateTo(Page.HOME)} className="text-white/80 hover:text-yellow-400 text-[11px] font-black transition-all flex items-center gap-2 uppercase tracking-tighter">○ {m}</button></li>
                ))}
              </ul>
            </div>
